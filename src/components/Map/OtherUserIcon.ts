...
export const currentUserIconRed = L.divIcon({
    ...
    html: `<svg viewBox="-4 -1 30 45" fill="#dc3545" width="25px" height="41px" style="overflow: visible;"><path d="M12 0C5.373 0 0 5.373 0 12c0 8.284 12 24 12 24s12-15.716 12-24C24 5.373 18.627 0 12 0zm0 17a5 5 0 110-10 5 5 0 010 10z" stroke="white" stroke-width="1"/></svg>`,
    iconSize: [25, 41], // Standard Leaflet pin size
    iconAnchor: [12.5, 41], // Anchor point (bottom center tip)
    popupAnchor: [0, -41] // Popup anchor point relative to iconAnchor
});